    ...
    <g transform="translate(${t},${e}) scale(${n/64})" stroke="${o}" fill="none"
      ...
      ${r||o?B`
          <text class="floor-val" x="${t.x+t.w-20}" y="${t.y+32}" text-anchor="end">
            ...
            ${o?B`<tspan class="dim">${c} </tspan><tspan class="val-island strong">${Et(s)}</tspan>`:q}
          </text>
        `:q}
